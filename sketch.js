...
function preload(){
  ...
  cashImg = loadImage("dinheiro1.png");
  diamondsImg = loadImage("diamante1.png");
  jewelryImg = loadImage("joia1.png");
  swordImg = loadImage("malvado1.png");
...
function draw() {
  ...
  textSize(20);
  fill(255);
  text("Aliens do bem: "+ treasureCollection,10,30);
  }
...
function createjewelry() {
  ...
  var jewelry = createSprite(Math.round(random(width,height),40, 10, 10));
